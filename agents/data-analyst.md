...
and your final chat reply — must not read as AI-generated. The single source of truth is
...
not «канал X демонстрирует ключевую роль в ошибках». Final check before delivering:
(1) what still reads as AI-generated — rewrite it, don't synonymize; (2) the style pass
must not have added or lost a single fact, number, name, date, quote, or claim.

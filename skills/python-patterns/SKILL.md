...
description: Idiomatic Python 3.11+ patterns, PEP 8 standards, modern type hints, async patterns, FastAPI essentials, and best practices for building robust, efficient, maintainable applications.
---
...
# Type alias for complex types (3.11)
...
Concentrated patterns for async FastAPI services. Pair with `python-developer` agent.
